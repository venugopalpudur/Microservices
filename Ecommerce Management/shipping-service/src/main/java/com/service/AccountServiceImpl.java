...
public class AccountServiceImpl implements UserDetailsService, AccountService{
	...
	public void signUp(UserDTO userDTO) {
		...
		customerDto.setCustomerName(userDTO.getName());
		customerDto.setCustomerEmail(userDTO.getEmail());
		customerDto.setCustomerBillingAddress(userDTO.getCustomerBillingAddress());
		customerDto.setCustomerShippingAddress(userDTO.getCustomerShippingAddress());
		ResponseDto responseDto = shoppingService.createCustomer(customerDto);
		user.setCustomerId(responseDto.getCustomer().getId());
