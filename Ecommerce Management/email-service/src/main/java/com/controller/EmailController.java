...
public class EmailController {
	...
	public void sendMailConfirmationMail(@RequestParam("userMail") String userMail, @RequestParam("token") String token) {
		...
		mailMessage.setText(
				"e-Mail ID changed successfully. Please click on the below link to confirm your account e-Mail ID changes." + "http://localhost:4200/account/confirm/e-mail?token="
						+ token);
